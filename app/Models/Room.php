...
class Room extends Model
{
    ...
    //listas blancas para ordenamiento
    ...
    // Relación con el modelo Hotel de uno a muchos
    ...
    {
        return $this->belongsToMany(Agency::class, 'agency_reservations')
    ...
    {
        return $this->belongsToMany(Individual::class, 'individual_reservations')
            ->withPivot('start_date', 'end_date')
            ->withTimestamps();
    }   

    // Scope para filtrar por tipo de habitación
    public function scopeByType(Builder $query, string $type)
    {
        return $query->where('type', $type);
    }
    //ahora los Scopes para filtros y ordenamiento
